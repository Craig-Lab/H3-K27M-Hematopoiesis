...
df_K27M = CSV.read(joinpath(@__DIR__, "..", "Results", bloodModel_K27M, "K27M ASA.csv"), DataFrame);
...
# H3-WT
df_CI_WT = CSV.read(joinpath(@__DIR__,"..", "Results", "Solution CI95 WT.csv"), DataFrame);
...
# H3-K27M
df_CI_K27M = CSV.read(joinpath(@__DIR__,"..", "Results", "Solution CI95 K27M.csv"), DataFrame);
