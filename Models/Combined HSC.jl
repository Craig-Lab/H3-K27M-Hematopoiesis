...
"p<sub>EP+\u2192EP-</sub>", "d<sub>MPP</sub>", "d<sub>CMP</sub>", "p<sub>GMP\u2192M</sub>", "d<sub>MEP</sub>", "p<sub>MLP\u2192M</sub>", "d<sub>EP+</sub>", "p<sub>EP-\u2192M</sub>"];
...
#            [aHSC   pH_MPP pM_CMP pC_GMP pC_MEP pM_MLP pME_EP pEP_EP dMPP   dCMP   dGMP   dMEP   dMLP   dEP+   dEP-  ];
L_WT   = vec([0.0000 1.0000 1.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000]);
U_WT   = vec([0.0300 6.0000 10.000 4.0000 6.0000 0.2000 10.000 3.0000 4.0000 2.0000 2.0000 4.0000 0.1000 2.0000 4.0000]);

L_K27M = vec([0.0300 2.0000 1.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000]);
U_K27M = vec([0.0600 8.0000 8.0000 4.0000 6.0000 0.1000 10.000 1.5000 6.0000 1.5000 4.0000 4.0000 0.2000 1.5000 4.0000]);
...
# Model where we consider HSC1 and HSC2 as one population of LT-HSCs.
   ...
   dHSC = a1*HSC; #a1 = k1 - p1
   dMPP = p1*HSC - (d3+p3+p6)*MPP;
