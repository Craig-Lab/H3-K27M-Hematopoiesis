...
"p<sub>MEP\u2192EP+</sub>", "p<sub>EP+\u2192EP-</sub>", "d<sub>MPP</sub>", "d<sub>CMP</sub>", "p<sub>GMP\u2192M</sub>", "d<sub>MEP</sub>", "p<sub>MLP\u2192M</sub>", "d<sub>EP+</sub>", "p<sub>EP-\u2192M</sub>", 
...
#            [aHSC1  p1_MPP aHSC2  p2_MPP pM_CMP pC_GMP pC_MEP pM_MLP pME_EP pEP_EP dMPP   dCMP   dGMP   dMEP   dMLP   dEP+   dEP-   r12    r21   ];
L_WT   = vec([0.0000 1.0000 0.0000 1.5000 1.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000]);
U_WT   = vec([0.0200 8.0000 0.0400 8.0000 8.0000 4.0000 5.0000 0.2000 10.000 3.0000 3.0000 2.0000 1.0000 4.0000 0.1000 2.0000 2.0000 0.0500 0.0200]);

L_K27M = vec([0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000]);
U_K27M = vec([0.0600 5.0000 0.0700 8.0000 8.0000 3.0000 5.0000 0.1000 10.000 1.0000 5.0000 1.5000 3.0000 4.0000 0.2000 1.5000 4.0000 0.0500 0.0500]);
...
# Model where we consider HSC1 and HSC2 as transiting populations of LT-HSCs.
        ...
        dHSC1 = a1*HSC1 + r21*HSC2; # with a1 = k1 - p1 - r12
        dHSC2 = a2*HSC2 + r12*HSC1; # with a2 = k2 - p2 - r21
        dMPP  = p1*HSC1 + p2*HSC2 - (d3+p3+p6)*MPP;
