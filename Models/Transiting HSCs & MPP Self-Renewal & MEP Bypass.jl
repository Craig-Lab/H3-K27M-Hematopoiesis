...
"p<sub>MEP\u2192EP+</sub>", "p<sub>EP+\u2192EP-</sub>", "p<sub>MPP\u2192EP+</sub>", "k<sub>MPP</sub>", "d<sub>CMP</sub>", "p<sub>GMP\u2192M</sub>", "d<sub>MEP</sub>", "p<sub>MLP\u2192M</sub>", "d<sub>EP+</sub>", "p<sub>EP-\u2192M</sub>", 
...
#            [aHSC1  p1_MPP aHSC2  p2_MPP pM_CMP pC_GMP pC_MEP pM_MLP pME_EP pEP_EP pM_EPp kMPP   dCMP   dGMP   dMEP   dMLP   dEP+   dEP-   r12    r21   ];
L_WT   = vec([0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000]);
U_WT   = vec([0.0200 0.5000 0.0400 0.5000 8.0000 4.0000 5.0000 0.2000 10.000 3.0000 4.0000 6.0000 2.0000 3.0000 4.0000 0.1000 2.0000 2.0000 0.0500 0.0200]);
...
U_K27M = vec([0.0500 0.5000 0.0500 0.5000 8.0000 4.0000 5.0000 0.1000 10.000 2.0000 4.0000 6.0000 2.0000 4.0000 4.0000 0.2000 1.5000 3.0000 0.0500 0.0500]);
...
# Model where we consider HSC1 and HSC2 as transiting populations of LT-HSCs.
        ...
        dMPP  = p1*HSC1 + p2*HSC2 - (p3+p6-k3+p9)*MPP;
