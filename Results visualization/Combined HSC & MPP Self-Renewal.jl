...
"p<sub>EP+\u2192EP-</sub>", "k<sub>MPP</sub>", "d<sub>CMP</sub>", "p<sub>GMP\u2192M</sub>", "d<sub>MEP</sub>", "p<sub>MLP\u2192M</sub>", "d<sub>EP+</sub>", "p<sub>EP-\u2192M</sub>"];
N_param = size(labs,1);
...
#            [aHSC   pH_MPP pM_CMP pC_GMP pC_MEP pM_MLP pME_EP pEP_EP kMPP   dCMP   dGMP   dMEP   dMLP   dEP+   dEP-  ];
L_WT   = vec([0.0000 0.0000 1.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000]);
U_WT   = vec([0.0300 0.5000 6.0000 4.0000 4.0000 0.1000 10.000 3.0000 6.0000 2.0000 1.5000 3.0000 0.1000 2.0000 1.0000]);

L_K27M = vec([0.0300 0.0000 1.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000 0.0000]);
U_K27M = vec([0.0600 0.5000 6.0000 3.0000 3.0000 0.0700 10.000 1.0000 6.0000 1.5000 4.0000 3.0000 0.2000 1.0000 2.5000]);
...
# Model where we consider HSC1 and HSC2 as one population of LT-HSCs.
    ...
    k3 = param[9];
    d4 = param[10]; d5 = param[11];
    d6 = param[12]; d7 = param[13];
    d8 = param[14]; d9 = param[15];
