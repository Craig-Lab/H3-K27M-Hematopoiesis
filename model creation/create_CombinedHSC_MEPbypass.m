%--------------------------------------------------------------------------
% File that creates the Combined HSCs with MEP Bypass model. 
% It stores it in a mat-file in the 'model' file.
%--------------------------------------------------------------------------
clear all;

syms k1 p1 p3 p4 p5 p6 p7 p8 p9 d3 d4 d5 d6 d7 d8 d9 ...
...
save('../models/CombinedHSC_MEPbypass','x','h','u','p','f','ics','known_ics');
