%--------------------------------------------------------------------------
% File that creates the Transiting HSCs model. 
% It stores it in a mat-file in the 'model' file.
%--------------------------------------------------------------------------
clear all;

syms k1 k2 p1 p2 p3 p4 p5 p6 p7 p8 d3 d4 d5 d6 d7 d8 d9 r12 r21 ...
...
save('../models/TransitingHSC.mat','x','h','u','p','f','ics','known_ics');